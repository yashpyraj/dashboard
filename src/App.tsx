        ...
        <Router>
          ...
          <main className="flex-1">
            <Routes>
              ...
              <Route path="/alliance/:allianceId/player/:playerId" element={<PlayerDetail />} />
              <Route path="/leaderboard" element={<AllianceLeaderboard />} />
              <Route path="/universal-leaderboard" element={<UniversalLeaderboard />} />
              ...
              <Route path="/fantasy-event/:eventId" element={<FantasyEventDetail />} />
              <Route path="/alliance/:id/comparison" element={<AllianceComparison />} />
              <Route path="/alliance-vs-alliance" element={<AllianceVsAlliance />} />
